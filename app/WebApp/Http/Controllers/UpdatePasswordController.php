...
final class UpdatePasswordController
{
	...
	public function __invoke(Request $request): JsonResponse
	{
		...
		$this->telegramClient->sendMessage((string) $telegramId, sprintf('Пароль обновлён (аккаунт #%d).', $accountId));

		return response()->json(['ok' => true, 'message' => 'Пароль обновлён. Ответ в чате.']);
	}
}
