...
return [
	...
	/**
	 * Quick actions in topbar dropdown.
	 * Each item: ['label' => 'Create account', 'route' => 'admin.accounts.create', 'icon' => 'database']
	 */
	'quick_actions' => [
		['label' => 'Create account', 'route' => 'admin.accounts.create', 'icon' => 'database'],
		['label' => 'Import accounts', 'route' => 'admin.import.accounts', 'icon' => 'upload'],
		['label' => 'Problems', 'route' => 'admin.problems.index', 'icon' => 'list'],
		['label' => 'Telegram users', 'route' => 'admin.telegram-users.index', 'icon' => 'users'],
	],
];